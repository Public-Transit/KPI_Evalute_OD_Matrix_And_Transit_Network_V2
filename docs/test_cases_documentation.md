...
| `fake_repo_f4.py` | F4 - O/D Priority Override | Khẳng định đặc quyền của Origin/Dest. Dù khoảng cách trên chuyến có xa hay việc chuyển tuyến có thuận lợi đến đâu, trạm Lên/Xuống đầu cuối **bắt buộc** phải ưu tiên gần tâm nhất. | Tính độc lập giữa O/D closest stop và Transfer intersection. |
