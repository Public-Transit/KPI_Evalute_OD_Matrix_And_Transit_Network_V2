...
class FakeRepoTotalPotentialDemandCase5(AbstractRepository):
    def __init__(self):
        ...
        self.od_pairs = []
        self.trips = []      
        self.candidate_trips_for_vis = [["S1", "S2", "S3", "S4", "S5", "S6", "S7", "S8", "S25", "S26", "S27"]] 
        ...
        # CASE 5 SPECIFIC
        self.od_pairs.append(ODPair("OD_1_8", "Z1", "Z8", 100.0))
        self.trips = [
            Trip([Leg("R1", "S3", "S9")]),
