...
class FakeRepoC1(AbstractRepository):
    """
    Circuity Case 1: Tuyến đi thẳng hoàn hảo.
    Độ vòng vèo (Circuity Index) dự kiến bằng 1.0 (hoàn hảo).
    """
    def __init__(self):
