...
class FakeRepoTotalPotentialDemandCase4(AbstractRepository):
    def __init__(self):
        ...
        self.od_pairs = []
        self.trips = []      
        self.candidate_trips_for_vis = [["S1", "S2", "S3", "S4", "S5", "S6", "S7", "S8", "S9", "S10"]] 
        ...
        # CASE 4 SPECIFIC
        self.od_pairs.append(ODPair("OD_1_4", "Z1", "Z4", 100.0))
        self.trips = [
            Trip([Leg("R1", "S4", "S7")]),
