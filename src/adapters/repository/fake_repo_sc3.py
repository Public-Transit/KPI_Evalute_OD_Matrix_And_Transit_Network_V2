...
class FakeRepoSC3(AbstractRepository):
    """
    Spatial coverage case 3:
    - Duplicate and overlapping stops stay inside the same origin zone.
    - Useful for proving unary union does not double count.
    """
    ...
    def __init__(self):
        ...
        self.routes = [
            Route(
                "R1",
                [P(100, 100), P(120, 100), P(100, 500)],
                ["S1_CENTER", "S1_DUPLICATE", "S1_NEAR", "S2_CENTER"],
            ),
        ]
