...
class FakeRepoSC2(AbstractRepository):
    """
    Spatial coverage case 2:
    - Origin stop stays inside the zone but close to the boundary.
    - The stop buffer is clipped by the zone boundary.
    """
    ...
    def __init__(self):
        ...
        self.routes = [
            Route("R1", [P(20, 100), P(100, 500)], ["S1_EDGE", "S2_CENTER"]),
        ]
