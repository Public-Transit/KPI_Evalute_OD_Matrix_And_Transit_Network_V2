...
class FakeRepoTotalPotentialDemandCase1(AbstractRepository):
    def __init__(self):
        ...
        self.od_pairs = []
        self.trips = []      
        self.candidate_trips_for_vis = [["S1", "S2", "S3", "S4", "S5", "S6", "S7"]] 
        ...
        # CASE 1 SPECIFIC
        self.od_pairs.append(ODPair("OD_1_3", "Z1", "Z3", 100.0))
        self.trips = [
            Trip([Leg("R1", "S7", "S10")]),
            Trip([Leg("R1", "S7", "S8"), Leg("R3", "S8", "S28")])
        ]
